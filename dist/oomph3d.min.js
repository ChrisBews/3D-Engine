var Oomph3D = (function (exports) {
  ...
  var FreeCamera = function (_PerspectiveCamera) {
      ...
      function FreeCamera(options) {
          ...
          _this._angleXInRadians = 0;
          _this._angleYInRadians = 0;
      ...
      createClass(FreeCamera, [{
          ...
          value: function _clearKeyRotations() {
              if (this._pressedKeys.indexOf('LeftArrow') === -1 && this._pressedKeys.indexOf('RightArrow') === -1 && !this._mouseXRotating) {
                  this._xRotationStrength = 0;
              }
              if (this._pressedKeys.indexOf('UpArrow') === -1 && this._pressedKeys.indexOf('DownArrow') === -1 && !this._mouseYRotating) {
