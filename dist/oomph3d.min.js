          ...
          value: function _generateMeshData() {
              ...
              for (var i = 0; i < this._segments; i++) {
                  ...
                  for (var k = 0; k < this._heightSegments; k++) {
                      ...
                      uvsArray.push(i / halfSegments, k / this._heightSegments, i / halfSegments, (k + 1) / this._heightSegments, (i + 1) / halfSegments, (k + 1) / this._heightSegments, (i + 1) / halfSegments, k / this._heightSegments);
  ...
  var Plane = function (_Mesh) {
      ...
      createClass(Plane, [{
          ...
          value: function _addDivision(startX, startZ, endX, endZ) {
              ...
              var startPercentY = 1 - (startZ + this._depth / 2) / this._depth;
              var endPercentX = (endX + this._width / 2) / this._width;
              var endPercentY = 1 - (endZ + this._depth / 2) / this._depth;
          ...
          value: function _generateMeshData() {
              ...
              for (var i = 0; i < this._longitudeBands; i++) {
                  ...
                  for (var k = 0; k < this._latitudeBands; k++) {
                      ...
                      var v = 1 - k / (this._latitudeBands / 2);
                      var u = 1 - i / this._longitudeBands;
                      var v2 = 1 - (k + 1) / (this._latitudeBands / 2);
                      var u2 = 1 - (i + 1) / this._longitudeBands;
                      if (i === 0) {
